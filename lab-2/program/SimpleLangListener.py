...
class SimpleLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleLangParser#Comp.
    def enterComp(self, ctx:SimpleLangParser.CompContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#Comp.
    def exitComp(self, ctx:SimpleLangParser.CompContext):
        pass
